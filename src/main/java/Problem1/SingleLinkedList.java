...
public class SingleLinkedList {
    ...
    protected final ListNode head = new ListNode();   // a dummy node for the linked list to make code simpler
    ...
    public SingleLinkedList(SingleLinkedList otherList) {
        ...
        head.next = otherList.head.next;    // TODO: bad implementation. Remove and replace with your own code.
    }
